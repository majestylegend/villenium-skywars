...
public class PlayerManager {
    ...
    private AthenaStorage<GamePlayer> PLAYERS = GameApi.getStorageManager().create("skywars_players_test", GamePlayer.class);
    @Getter
    private ObjectPool<GamePlayer> objectPool;

    public void initialize() {
        objectPool = PLAYERS.newObjectPool();
        objectPool.setDefaultObject(new GamePlayer(null, new HashMap<>(), new ArrayList<>(), null, 0, 0, 0, 0, new HashMap<>(), false));
    }
